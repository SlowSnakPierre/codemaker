...
const getBabelConfig = () => {
	if (fs.existsSync(path.join(cwd$1, ".babelrc")))
		return path.join(cwd$1, ".babelrc");
	if (fs.existsSync(path.join(cwd$1, ".babelrc.js")))
		return path.join(cwd$1, ".babelrc.js");
	if (fs.existsSync(path.join(cwd$1, "babel.config.js")))
		return path.join(cwd$1, "babel.config.js");
